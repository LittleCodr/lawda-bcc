...
export const metadata: Metadata = {
  title: "Men's Collection | Octopus Perfume by Harsh Beniwal",
  description: "Shop luxury perfumes for men by Octopus Perfume.",
  alternates: {
    canonical: "https://octopusperfume.in/collections/mens-perfume",
  },
};

export default function CollectionPage() {
  const collectionProducts = products.filter(p => p.gender.includes("Him"));

  const collectionJsonLd = {
    "@context": "https://schema.org",
    "@type": "ItemList",
    name: "Men's Collection | Octopus Perfume",
    description: "Shop luxury perfumes for men by Octopus Perfume.",
    url: "https://octopusperfume.in/collections/mens-perfume",
  ...
  return (
    <div className="mx-auto max-w-[1440px] px-5 md:px-10 py-16 md:py-24">
      ...
      <div className="flex flex-col items-center text-center mb-14">
        ...
        <h1 className="font-serif-display text-4xl md:text-6xl">Men's Collection</h1>
      </div>
