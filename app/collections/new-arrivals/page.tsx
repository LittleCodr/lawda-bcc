...
export const metadata: Metadata = {
  title: "New Arrivals | Octopus Perfume by Harsh Beniwal",
  description: "Shop the newest luxury perfumes by Octopus Perfume.",
  alternates: {
    canonical: "https://octopusperfume.in/collections/new-arrivals",
  },
};
...
export default function CollectionPage() {
  ...
  const collectionJsonLd = {
    ...
    "@type": "ItemList",
    name: "New Arrivals | Octopus Perfume",
    description: "Shop the newest luxury perfumes by Octopus Perfume.",
    url: "https://octopusperfume.in/collections/new-arrivals",
  ...
  return (
    <div className="mx-auto max-w-[1440px] px-5 md:px-10 py-16 md:py-24">
      ...
      <div className="flex flex-col items-center text-center mb-14">
        ...
        <h1 className="font-serif-display text-4xl md:text-6xl">New Arrivals</h1>
      </div>
