...
export const metadata: Metadata = {
  title: "Best Sellers | Octopus Perfume by Harsh Beniwal",
  description: "Shop our best-selling luxury perfumes by Octopus Perfume.",
  alternates: {
    canonical: "https://octopusperfume.in/collections/best-sellers",
  },
};
...
export default function CollectionPage() {
  ...
  const collectionJsonLd = {
    ...
    "@type": "ItemList",
    name: "Best Sellers | Octopus Perfume",
    description: "Shop our best-selling luxury perfumes by Octopus Perfume.",
    url: "https://octopusperfume.in/collections/best-sellers",
  ...
  return (
    <div className="mx-auto max-w-[1440px] px-5 md:px-10 py-16 md:py-24">
      ...
      <div className="flex flex-col items-center text-center mb-14">
        ...
        <h1 className="font-serif-display text-4xl md:text-6xl">Best Sellers</h1>
      </div>
