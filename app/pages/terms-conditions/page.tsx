    ...
    <div className="bg-paper min-h-screen selection:bg-ink selection:text-paper pt-24 pb-16 px-6 md:px-10 md:pt-32 md:pb-24">
      <div className="max-w-3xl mx-auto space-y-12">
        <div className="text-center border-b border-ink/10 pb-10">
          ...
          <p className="text-ink/60 text-sm tracking-widest uppercase">Last Updated on April 8, 2026</p>
        </div>

        <div className="prose prose-sm md:prose-base prose-ink max-w-none space-y-8">
          <section>
            <p className="text-ink/80 leading-relaxed mb-4">
              The terms "We" / "Us" / "Our"/”Company”/”Octopus” individually and collectively refer to Octopus Lifestyle Private Limited and the terms "Visitor” ”User” refer to the users. 
            </p>
            <p className="text-ink/80 leading-relaxed mb-4">
          ...
          <section>
            <h2 className="font-serif-display text-2xl text-ink mb-4">USE OF CONTENT</h2>
            <p className="text-ink/80 leading-relaxed mb-4">
          ...
          <section>
            <h2 className="font-serif-display text-2xl text-ink mb-4">PRODUCTS OR SERVICES (if applicable)</h2>
            <p className="text-ink/80 leading-relaxed mb-4">
          ...
          <section>
            <h2 className="font-serif-display text-2xl text-ink mb-4">ACCEPTABLE WEBSITE USE</h2>
            
            <h3 className="font-bold text-ink mb-2">(A) Security Rules</h3>
            <p className="text-ink/80 leading-relaxed mb-4">
            ...
            <h3 className="font-bold text-ink mb-2">(B) General Rules</h3>
            <p className="text-ink/80 leading-relaxed mb-4">
          ...
          <section>
            <h2 className="font-serif-display text-2xl text-ink mb-4">DISCLAIMER OF CONSEQUENTIAL DAMAGES</h2>
            <p className="text-ink/80 leading-relaxed mb-4">
